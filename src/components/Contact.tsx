...
const contactMethods = [
  {
    icon: Mail,
    label: 'Email',
    value: 'saurabhbiware@gmail.com',
    href: 'mailto:saurabhbiware@gmail.com',
    bg: 'bg-blue-700',
  ...
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/saurabh-biware',
    href: 'https://github.com/Saurabh-Biware',
    bg: 'bg-gray-700',
    iconColor: 'text-white',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/saurabh-biware',
    href: 'https://linkedin.com/in/saurabh-biware',
    bg: 'bg-blue-800',
    iconColor: 'text-white',
  },
];
  ...
  <Card className="glowing-card bg-gray-900/70 border-gray-800 rounded-xl transition-all duration-300 overflow-hidden h-full flex flex-col justify-center">
    ...
    <CardContent>
      <p className="text-gray-300 text-base mb-8">
              I'm a Full Stack Engineer with specialization in backend work, creating intuitive and intelligent applications that solve complex problems.
            </p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        //web3 forms is used for form handling and email sending service
        body: JSON.stringify({
          access_key: '2cb3a591-8c05-4176-b787-588868a20865',
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex gap-4">
            <div className="flex-1 space-y-2">
              ...
              <Input 
                ...
                className="bg-transparent border-2 border-blue-700 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500/20 transition-colors input-shadow-effect rounded-xl"
            ...
            <div className="flex flex-wrap gap-3">
              {['Freelance', 'Collaboration', 'Enquiry','Hire'].map(option => (
                <button
                  ...
                  className={`px-4 py-2 input-shadow-effect border-2 border-blue-700 text-white font-semibold focus:outline-none transition-colors duration-200 rounded-xl ${formData.reason === option ? 'bg-blue-600' : 'bg-gray-800'} ${formData.reason === option ? 'ring-2 ring-blue-400' : ''}`}
                >
                  {option}
                </button>
              ))}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={handleChange}
              rows={5}
              className="bg-transparent border-2 border-blue-700 text-white placeholder-gray-400 focus:border-blue-500 focus:ring-blue-500/20 transition-colors resize-none input-shadow-effect rounded-xl"
